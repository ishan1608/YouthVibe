...
public class PhotographyFragment extends Fragment	  
{
	...
	{
		rootView  = inflater .inflate(R.layout.photography_fragment, container, false);
		...
		for(int i=0; i<imageItems.length; i++) {
			...
			imageHolder[i].setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					transaction.replace(R.id.photography_categories_fragment_container, nextFragment);
